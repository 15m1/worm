...
function base(size: number | undefined, rest: Record<string, unknown> = {}) {
  return {
    width: size ?? 18,
    height: size ?? 18,
    viewBox: '0 0 24 24',
...
export const IconReview = ({ size }: IconProps) => (
  <svg {...base(size)}>
...
export const IconStar = ({ size }: IconProps) => (
  <svg {...base(size)} fill="currentColor" stroke="currentColor">
